...
1. Prepare your wires  
	...
	b. Do the same for two breadboard wires (cut off one end, leaving the female adapter on, and strip to reveal wire). You will use these to connect the sound card to the IN terminal of the amplifier
